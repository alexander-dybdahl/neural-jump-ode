...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Ornstein-Uhlenbeck Neural Jump ODE Experiment')
    ...
    parser.add_argument('--theta', type=float, default=1.0, help='OU mean reversion speed')
    parser.add_argument('--mu', type=float, default=0.5, help='OU long-term mean')
    parser.add_argument('--sigma', type=float, default=0.3, help='OU volatility')
    ...
    parser.add_argument('--x0', type=float, default=0.0, help='Initial value')
